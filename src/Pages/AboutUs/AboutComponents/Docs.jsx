            ...
            <section className="py-6 dark:bg-gray-800 dark:text-gray-100">
                <div className="container p-4 mx-auto space-y-16 sm:p-10">
                    <div className="space-y-4">
                        <h3 className="text-2xl text-center font-bold  sm:text-5xl">Meet our team</h3>
                        <p className="max-w-2xl text-center mx-auto dark:text-gray-400">
                            Get to know the dedicated individuals behind PrimeCare Diagnostics Center. Our team is a diverse blend of expertise and passion, united by a common goal: your health and well-being. Meet the faces driving precision diagnostics and compassionate care at PrimeCare Diagnostics Center.
                        </p>
                    </div>
