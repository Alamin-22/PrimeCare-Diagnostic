...
import CallAnimation from "../../../public/Animation/Animation - 1700853774312.json"
const ContactUs = () => {
                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                        ...
                        <div className="p-4 py-6 rounded-lg bg-emerald-50  md:p-8">
                            <form onSubmit={handleContact}>
                                ...
                                <button type="submit" className="w-full btn mt-3 bg-[#219ebc] hover:bg-[#3c738f] border-none text-white" >
                                    Send message
                                </button>
                            </form>
                        </div>
