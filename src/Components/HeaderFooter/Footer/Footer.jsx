...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 py-12  bg-[#73d5ee60]">
                        ...
                        <div className="col-span-3">
                            ...
                            <form  className="mb-2">
                                <div className="form-append">
                                    ...
                                    <button className="btn bg-[#219ebc] hover:bg-[#3c738f] text-white  btn-sm mt-1 w-full" type="submit">Subscribe</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div className="flex flex-col items-start justify-between pt-10 mt-10 border-t border-gray-100 md:flex-row md:items-center">
                        <p className="mb-6 text-sm text-left text-gray-600 md:mb-0">© Copyright 2020 . All Rights Reserved by PrimeCare Diagnostics.</p>
